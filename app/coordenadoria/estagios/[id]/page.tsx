...
import { getCoordinationInternshipDetail } from "@/lib/queries/coordination-internship-detail";
...
export default async function UnidadeEstagiarioHistoricoPage({
  ...
  const { detail, error } = await getCoordinationInternshipDetail(id);
  ...
  return (
    <SystemShell
      ...
      description="Consulta consolidada do estágio para acompanhamento da Coordenadoria."
    >
